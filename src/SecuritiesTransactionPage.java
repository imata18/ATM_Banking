...
public class SecuritiesTransactionPage {
    ...
    public SecuritiesTransactionPage(Customer inputUser, UserHomePage homepage) {
    	home = homepage;
    	user = inputUser;
    	
    	tabbedPane = new JTabbedPane(JTabbedPane.LEFT);
    	
    	securities = user.getSecurities();
    	
    	if(securities != null) {
	    	statement = securities.getStatement();
    		...
    		JLabel temp = new JLabel("You do not have a securities account");
